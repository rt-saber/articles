...
and release schedule was shared with them before publishing:
...
We advised them to inform KISA and KrCERT. Communication then ended abruptly.<BR>  
An appeal was filed with Proton. Proton replied: **"your account will cause
further damage to our service, therefore we will keep the account suspended"**.<BR>
Proton ignored any further request for clarification (Proton was used only for email and only to communicate with South Korea).<BR>
