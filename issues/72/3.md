...
1. [THE LINUX UPNP INTERNET GATEWAY DEVICE](https://linux-igd.sourceforge.net/changelog.php)
2. [Linux UPnP Internet Gateway Device](https://sourceforge.net/projects/linux-igd/)
3. [Fedora-Live-Workstation-x86_64-21-5.iso](https://dl02.fedoraproject.org/pub/archive/fedora/linux/releases/21/Workstation/x86_64/iso/Fedora-Live-Workstation-x86_64-21-5.iso)
4. [Portable UPnP SDK](https://sourceforge.net/projects/pupnp/)
5. [libupnp-1.3.1.tar.gz](https://sourceforge.net/projects/pupnp/files/pupnp/libUPnP%201.3.1/)
<PRE>
...
Secondly, it targeted the current version [at the time](https://github.com/klange/toaruos/tree/a54a0cbbee1ac18bceb2371e49876eab9abb3a11) of the OS.
...
You were provided a low-priv remote shell running on [ToaruOS](https://github.com/klange/toaruos) and had
